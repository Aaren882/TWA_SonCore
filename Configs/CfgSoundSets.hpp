...
class JetFX_EngineLowExt_Distance_Front_SoundSet_Base: JetFX_EngineExt_Close_Front_SoundSet_Base
{
	soundShaders[] = 
	{
...
class JetFX_EngineNoise_Ext_SoundSet: JetFX_External_Close_Base
{
	soundShaders[] = 
	{
		"JetFX_EngineNoise_Ext_SoundShader"
	};
	shape="JetFX_RearSideClose_shape";
	volumeCurve="JetFX_EngineExt_Intense_Base_Curve";
	volumeFactor=0.8;
...
class JetFX_EngineLowExt_Distance_SoundSet_Base: JetFX_ForsageExtDis_SoundSet_Base
{
	soundShaders[] = 
	{
